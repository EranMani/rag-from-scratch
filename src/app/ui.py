                                    ...
                                    with ui.card().style(
                                        ...
                                        with ui.row().style("gap:12px; flex-wrap:wrap; margin-bottom:20px"):
                                            _intro_cards: list[tuple[str, str]] = [
                                                (
                                                    "What is RAG?",
                                                    "Retrieval-Augmented Generation combines a knowledge base with an AI "
                                                    "language model, giving it grounded answers instead of guesses.",
                                                ),
                                                (
                                                    "How this app works",
                                                    "Ask questions, answer occasional knowledge checks, and the system adapts "
                                                    "your learning profile as you go.",
                                                ),
                                                (
                                                    "What you'll cover",
                                                    "Chunking, embeddings, retrieval, LangChain, LangGraph, evaluation, "
                                        ...
                                        with ui.row().style("flex-wrap:wrap; gap:8px; margin-top:4px"):
